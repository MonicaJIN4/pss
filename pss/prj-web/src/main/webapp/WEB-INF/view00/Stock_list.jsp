...
<nav class="breadcrumb">
    ...
    商品管理 <span class="c-gray en">&gt;</span>库存
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<%--<a href="javascript:;" onclick="item_add('添加','Stock?oper=insert','800','500')"--%>
        ...
        <table id="datalist" class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <c:forEach var="item" items="${DataList}">
                <tr class="text-c">
                    ...
                    <td>
                        <%--<a title="删除" href="javascript:;" onclick="item_del(this,${item.stockId})" class="ml-5" style="text-decoration: none">--%>
                            <%--<i class="Hui-iconfont">&#xe6e2;</i>--%>
                        <%--</a>--%>
                        <%--<a title="编辑" href="javascript:;" onclick="item_edit('编辑[id=${item.stockId}]',--%>
                                <%--'Stock?oper=update&id=${item.stockId}','1','800','500')" class="ml-5" style="text-decoration: none">--%>
                            <%--<i class="Hui-iconfont">&#xe6df;</i>--%>
                        <%--</a>--%>
                        <a title="查看详情" href="javascript:;" onclick="item_detail('查看[Id=${item.stockId}]',
                                'Stock?oper=detail&id=${item.stockId }','4','800','500')" class="ml-5" style="text-decoration: none">
                            <i class="Hui-iconfont">&#xe707;</i>
                        </a>
                    </td>
                </tr>
