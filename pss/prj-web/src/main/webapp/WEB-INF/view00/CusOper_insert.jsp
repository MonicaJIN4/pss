...
<article class="page-container">
	<form action="CusOper"  method="post" class="form form-horizontal" id="objForm">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<button class="btn radius btn-primary size-S"
						onclick="item_add('添加客户','CusContact?oper=insert','600','400')">添加客户</button>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value="${cusTel}" placeholder="" id="cusTel" name="cusTel">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>客户地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value="${cusAddr}" placeholder="" id="cusAddr" name="cusAddr">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>员工名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<select class="select-box" style="width: 200px" id="staffId" name="staffId">
					<option style="width: 200px;" value="">请选择</option>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>传真号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value="${faxNum}" placeholder="" id="faxNum" name="faxNum">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>公司名字：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value="${comName}" placeholder="" id="comName" name="comName">
			</div>
		</div>
