...
<article class="page-container">
	<form action="SaleReturn"  method="post" class="form form-horizontal" id="objForm">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">售出数量：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px" value="" placeholder="" id="number" name="number"> ${unit}
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">售出价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px" value="" placeholder="" id="price" name="price"> 元
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">备注：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px" value="${remark}" placeholder="" id="remark" name="remark">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>退货日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date"  class="input-text" style="width: 200px" value="${returnDate}" placeholder="" id="returnDate" name="returnDate">
			</div>
		</div>
...
<script type="text/javascript">
	...
	$(function () {
		...
		var infoDate = document.getElementById('returnDate');
		var now = new Date();
		<%--${'#date'}.val('2018-11-1');--%>
