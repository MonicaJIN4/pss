...
<div class="pd-20">
	<article class="page-container">
		<input type="hidden" name="userId" value="${bean.saleId}" /> <div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">Id:</label>
		<div class="formControls col-xs-8 col-sm-9">${bean.saleId}</div> </div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">商品ID:</label>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> ${bean.cusId}</div>
		</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">销售时间:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.outDate}</div>
		</div>
