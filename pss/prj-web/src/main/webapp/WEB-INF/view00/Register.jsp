...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/H-ui.admin/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/static/H-ui.admin/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form class="form form-horizontal" action="Register" method="post" id="objForm">
            <input type="hidden" name="oper" value="insertRegister"/>
            <input type="hidden" name="msg" id="msg" value="${msg}"/>

            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
                <div class="formControls col-xs-8">
                    <input id="userName" name="userName" type="text" value="${userName}" placeholder="用户名" class="input-text size-L">
                </div>
