...
<title>添加采购退货 - H-ui.admin v3.1</title>
...
<article class="page-container">
	<form action="ReturnNote"  method="post" class="form form-horizontal" id="objForm">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">供应商名称：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">进货数量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span >
					${number} ${unit}</span>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value="" placeholder="" id="returnPrice" name="returnPrice">
			 元</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">采购价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span id="buyPrice" >
					${buyPrice} 元</span>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value=""  id="remark" name="remark">
			</div>
		</div>
		<div class="row cl">
