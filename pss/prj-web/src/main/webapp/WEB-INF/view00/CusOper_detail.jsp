...
<div class="pd-20">
	<article class="page-container">
		<input type="hidden" name="userId" value="${bean.cusId}" /> <div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">ID:</label>
		<div class="formControls col-xs-8 col-sm-9">${bean.cusId}</div> </div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> ${bean.cusTel}</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">客户地址:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.cusAddr}</div>
		</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">传真号:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.faxNum}</div>
		</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">公司名字:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.comName}</div>
		</div>
