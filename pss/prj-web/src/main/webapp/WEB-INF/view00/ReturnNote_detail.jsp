...
<div class="pd-20">
	<article class="page-container">
		<input type="hidden" name="purId" value="${bean.returnId}" /> <div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">退货单单号:</label>
		<div class="formControls col-xs-8 col-sm-9">${bean.returnId}</div> </div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">供应商名:</label>
			<div class="formControls col-xs-8 col-sm-9">${bean.supId}</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">商品名:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.cargoId}</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">数量:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.number}</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">单价:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.returnPrice}</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">总金额:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.total}</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">退货日期:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.returnDate}</div>
		</div>
