...
<article class="page-container">
	<form action="SaleReturn"  method="post" class="form form-horizontal" id="objForm">
		...
		<input type="hidden" name="id" value="${reSaleId}" />
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px" value="${number}" placeholder="" id="number" name="number"> ${unit}
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>退货单价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px" value="${price}" placeholder="" id="returnPrice" name="returnPrice"> 元
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">售出单价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span id="sellPrice" >
				${sellPrice} 元</span>
			</div>
