...
<article class="page-container">
	<form action="CusContact"  method="post" class="form form-horizontal" id="objForm">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value="${cusName}" placeholder="" id="cusName" name="cusName">
			</div>
		</div>
		<div class="row cl">
