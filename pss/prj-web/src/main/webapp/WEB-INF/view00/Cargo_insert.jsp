...
<article class="page-container">
	<form action="Cargo"  method="post" class="form form-horizontal" id="objForm">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input style="width: 200px;" type="text" class="input-text" value="${cargoName}" placeholder="" id="cargoName" name="cargoName">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  style="width: 200px;" type="text" class="input-text" value="${safetyStock}" placeholder="" id="safetyStock" name="safetyStock">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>单位：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input style="width: 200px;" type="text" class="input-text" value="${unit}" placeholder="" id="unit" name="unit">
			</div>
		</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>建议购买价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input style="width: 200px;" type="text" class="input-text" value="${buyPrice}" placeholder="" id="buyPrice" name="buyPrice"> 元
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>建议销售价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" style="width: 200px;" value="${sellPrice}" placeholder="" id="sellPrice" name="sellPrice"> 元
			</div>
		</div>
