...
<article class="page-container">
    <form action="User"  method="post" class="form form-horizontal" id="objForm">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input style="width: 200px;" type="text" class="input-text" value="${userName}" placeholder="" id="userName" name="userName">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input style="width: 200px;" type="text" class="input-text" value="${userPass}" placeholder="" id="userPass" name="userPass">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">
                <span class="c-red">*</span>职位名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <select id="roleId" name="roleId"  class="select-box" style="width: 200px">
