...
<nav class="breadcrumb">
    ...
    销售管理 <span class="c-gray en">&gt;</span> 销售退货
            ...
            <c:forEach var="item" items="${DataList}">
                <tr class="text-c">
                    ...
                    <td>
                        ...
                        <a title="编辑" href="javascript:;" onclick="item_edit('编辑[id=${item.reSaleId}]',
                                'SaleReturn?oper=update&id=${item.reSaleId}','1','800','500')"
                           class="ml-5" style="text-decoration: none">
                            <i class="Hui-iconfont">&#xe6df;</i></a>
                        <%--<a title="查看" href="javascript:;" onclick="item_detail('查看[Id=${item.reSaleId}]',--%>
                                <%--'SaleReturn?oper=detail&id=${item.reSaleId}','4','800','500')"--%>
                           <%--class="ml-5" style="text-decoration: none">--%>
                            <%--<i class="Hui-iconfont">&#xe707;</i></a>--%>
                    </td>
                </tr>
