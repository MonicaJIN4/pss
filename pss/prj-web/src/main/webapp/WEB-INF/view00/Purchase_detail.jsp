...
<div class="pd-20">
	<article class="page-container">
		<input type="hidden" name="purId" value="${bean.purId}" /> <div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">采购单单号:</label>
		<div class="formControls col-xs-8 col-sm-9">${bean.purId}</div> </div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">供应商名:</label>
			<div class="formControls col-xs-8 col-sm-9">${bean.supName}</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> ${bean.number} ${bean.unit}</div>

		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">单价:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.buyPrice} 元 /${bean.unit}</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">总金额:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.total} 元</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">采购日期:</label>
			<div class="formControls col-xs-8 col-sm-9"> ${bean.date}</div>
		</div>
