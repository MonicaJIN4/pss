        ...
        <table id="datalist" class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr>
                <th scope="col" colspan="7">退货列表
                    <%--<a href="javascript:;" onclick="item_add('添加','ReturnNote?oper=insert&purId=${purId}','600','400')"--%>
                       <%--class="btn btn-primary radius" type="POST">--%>
                        <%--<i class="Hui-iconfont">&#xe600;</i> 添加</a>--%>
                    <a class="btn btn-success radius r"
                       href="javascript:location.replace(location.href);" title="刷新" >
                        <i class="Hui-iconfont">&#xe68f;</i></a></th>
            </tr>
            <tr class="text-c">
            ...
            <c:forEach var="item" items="${DataList}"> <tr class="text-c">
                ...
                <td>
                    ...
                    <a title="编辑" href="javascript:;" onclick="item_edit('编辑[id=${item.returnId}]','ReturnNote?oper=update&id=${item.returnId}','1','600','400')"
                       class="ml-5" style="text-decoration: none">
                        <i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="查看" href="javascript:;" onclick="item_detail('查看[Id=${item.returnId}]','ReturnNote?oper=detail&id=${item.returnId }','4','600','400')"
                       class="ml-5" style="text-decoration: none">
                        <i class="Hui-iconfont">&#xe707;</i></a>
                </td> </tr>
            </c:forEach>
