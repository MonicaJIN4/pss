...
<div class="pd-20">
    <article class="page-container">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">库存编号:</label>
            <div class="formControls col-xs-8 col-sm-9">${bean.stockId}</div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">当前数量:</label>
            <div class="formControls col-xs-8 col-sm-9">${bean.number} ${bean.unit}</div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">安全存量:</label>
            <div class="formControls col-xs-8 col-sm-9">${bean.safetyStock} ${bean.unit}</div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">最后进货日期:</label>
            <div class="formControls col-xs-8 col-sm-9">${bean.buyDate}</div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">最后送货日期:</label>
            <div class="formControls col-xs-8 col-sm-9">${bean.sellDate}</div>
        </div>
